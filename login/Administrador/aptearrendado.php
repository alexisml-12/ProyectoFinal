...
<head>
    ...
    <title>Apartamentos en arrendados</title>
    <style type="text/css">
...
<br>
<div class="container">
<h4 class="text-center">Apartamentos en arrendados</h4>
<br>
    <div class="row">
    <!--  -->
    <?php 
        $query = "SELECT * FROM `apartamentos` WHERE estado='arrendado' LIMIT 0, 25";
        ...
        <div class="col-sm-6">
            ...
            <div class="card-body">
                ...
                <a href="verinfoaptarren.php?id=<?php echo $fila['id']?>" class="btn btn-primary">Ver mas informacion</a>
            </div>
            </div>
            <br>
        </div>
